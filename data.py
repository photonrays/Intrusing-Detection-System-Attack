...
def split_features(dataframe, selected_attack_class):
    ...
    if selected_attack_class == 'DoS':
        ...
        normal_nff = remove_time_based(normal_nff)
    elif selected_attack_class == 'U2R' or selected_attack_class == 'R2L':
        functionnal_features = remove_host_based(functionnal_features)
        functionnal_features = remove_time_based(functionnal_features)
        non_functionnal_features = remove_content(non_functionnal_features)

        normal_ff = remove_host_based(normal_ff)
        normal_ff = remove_time_based(normal_ff)
        normal_nff = remove_content(normal_nff)
