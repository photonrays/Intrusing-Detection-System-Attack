...
class WGAN(object):
  ...
  def train(self, trainingset, validationset):
    ...
    # print("malicious_traffic: ", malicious_traffic)
    # print("malicious_labels: ", malicious_labels)
  ...
  def _add_scalars(self, writer, epoch, d_adv_mean, d_normal_mean, d_loss, g_loss):
    ...
    writer.add_scalar('discriminator/loss', d_loss, epoch)
    writer.add_scalar('generator/loss', g_loss, epoch)
  ...
  def _log_stats_to_tensorboard(self, writer, epoch, normal_traffic, normal_labels, malicious_traffic, malicious_labels):
      ...
      discriminator_loss = discriminated_normal_mean - discriminated_adversarial_mean
      generator_loss = discriminated_adversarial_mean
      ...
      return discriminated_adversarial_mean, discriminated_normal_mean, discriminator_loss, generator_loss
