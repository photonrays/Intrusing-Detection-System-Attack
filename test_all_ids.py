...
def parse_own_arguments(arguments):
    ...
    parser.add('--attack', required=False, default=None, choices=['DoS', 'Probe', 'U2R', 'R2L'], help='select attack class to only evaluate on this attack class (default evaluate on all)')
